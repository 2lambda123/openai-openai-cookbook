...
async def aget_embedding(text: str,
    ...
    return (await openai.embeddings.create(input=[text], model=model,
...
def get_embeddings(list_of_text: List[str],
    ...
    data = openai.embeddings.create(input=list_of_text, model=model,
                                    **kwargs).data
...
async def aget_embeddings(list_of_text: List[str],
    ...
    data = (await openai.embeddings.create(input=list_of_text,
                                           model=model,
                                           **kwargs)).data
    return [d.embedding for d in data]
